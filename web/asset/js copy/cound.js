(function (factory) {
  ...
  const issuesDiscoveredChartInit1 = () => {
    const { getColor, getData } = window.phoenix.utils;
  ...
  const issuesDiscoveredChartInit2 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const issuesDiscoveredChartEl = document.querySelector('.echart-issue-chart2');
  ...
  const issuesDiscoveredChartInit3 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const issuesDiscoveredChartEl = document.querySelector('.echart-issue-chart3');
  ...
  docReady(issuesDiscoveredChartInit1);
  docReady(issuesDiscoveredChartInit2);
  docReady(issuesDiscoveredChartInit3);
