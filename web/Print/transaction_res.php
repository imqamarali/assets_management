<?php 
    include "../db.php";
                ...
                $sqlmem= "SELECT *,plot_reserved_main.remarks as premarks,plot_reserved_main.id as prid,plot_reserved_main.uid as usid from plot_reserved_main
                Left Join members On (members.id=plot_reserved_main.member_id)
                Left Join plot_reserved ON (plot_reserved_main.id=plot_reserved.mid)
            ...
            <div style="min-height: 400px;border: 1px solid #000; padding: 15px;">
                <div>
                    ...
                    <div style="width:20%;float: left;margin-top: 15px; padding-bottom: 15px;"> <span> Voucher # : </span>
                        ...
                        <span> Comp # : </span> 
                        <span style="color:#999;"><?php echo $rowmem['prid']; ?></span>
                        <hr> 
                        <span> Dated : </span>
    ...
    <div style="width:40%;display: inline-block;">
       <span >
                        <?php
                            ...
                            if ($row['vtype'] == 3 or $row['vtype'] == 4)
                            {
                                echo 'Paid By:';
                            }
                        ?>
                    </span>
                    <span style="color:#999; width: 45%;">    
              <?php echo $rowmem['name']; ?></span>

    </div>
     <span style="width: 45%;">Cell #: </span> 
    <span style="color:#999; width: 45%"><?php echo $rowmem['phone']; ?></span> 
                    <hr />

         <span>Paid Of: </span> 
        <span style="color:#999;"><?php echo $rowmem['sector_name'].' , '.$rowmem['street'].'  , '.$rowmem['size'].' , '.$rowmem['plot_detail_address']; ?></span> 
                    <hr  />
                    ...
                    <div style="margin-top: 1%;">
                        ...
                        <table style="  font-family: arial, sans-serif; border-collapse: collapse; width: 100%;">
                            <tr>
                                ...
                                <th style="border: none;text-align:center; border-bottom: 2px solid #000000;"><?php echo $rowmem2['name'] ?></th>
