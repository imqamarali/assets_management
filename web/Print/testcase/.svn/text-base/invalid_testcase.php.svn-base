...
<ul class="menublock">
        ...
        <ul>
            <li>
                <a href="https://www.cyberciti.biz/tips/pollsarchive">Polls Archive</a>
            </li>
        </ul>
    </li>
</ul>
...
// BAD HTML test
$str = <<<HTML
<strong class="see <a href="https://www.oeb.harvard.edu/faculty/girguis/">https://www.oeb.harvard.edu/faculty/girguis/</a>">.</strong></p> 
HTML;
$dom->load($str);
// -----------------------------------------------
$str = <<<HTML
<a href="https://www.oeb.harvard.edu/faculty/girguis\">https://www.oeb.harvard.edu/faculty/girguis/</a>">
HTML;
$dom->load($str);
// -----------------------------------------------
$str = <<<HTML
