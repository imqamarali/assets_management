...
<div id="page-wrap">
  ...
  <table id="items">
    ...
    <tr>
	  <td><?php echo $i;?></td>
      <td align="left"><img height="80" style="max-width:165px;" src="<?php echo $row1['windowimage']; ?>" /></td>
     <td align="left">
     ...
     ?>
      ...
      <td  align="center"><?php echo number_format($row1['secprice'],2);?></td>
      <td align="center"><?php echo number_format($row1['glassprice'],2);?></td>
      <td align="center"><?php echo $row1['quantity'];?></td>
      <td colspan="2" align="right"><span class="price"><?php echo number_format(($row1['secprice']+$row1['glassprice'])*$row1['quantity'],2);?></span></td>
    </tr>
   ...
   <hr/>
    <tr>
      <td colspan="3" class="total-line">Total</td>
	   <td class="total-value" align="center"><div id="total"><?php echo number_format($tarea,2)?></div></td>
       <td class="total-value" align="center"><div id="total"><?php echo number_format($sp,2)?></div></td>
       <td class="total-value" align="center"><div id="total"><?php echo number_format($gp,2)?></div></td>
      <td class="total-value" align="center"><div id="total"><?php echo $qty?></div></td>
      <td class="total-value" align="right" colspan="2">
      <?php $ttotal=$gtotal;
    ...
    ?>
     ...
     <tr>
      <td colspan="7" class="total-line "><?php echo $rowch['details'];?></td>
    ...
    <tr>
	  ...
	  <?php echo number_format(($ttotal=$row['transpotation']+($row['installation']*$ins)+$gtotal+$ch+$row['tax']-$td),2);?>
      </div></td>
    </tr>
