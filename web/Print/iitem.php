				...
				include "db.php";
				$i=0;
				$sql= "SELECT *,item.name as iname,issueitems.qty as qty FROM issueitems 
			    LEFT JOIN boqtoitems ON (boqtoitems.invenitem=issueitems.item)
				LEFT JOIN item ON (boqtoitems.invenitem=item.id)			   
			    WHERE issueitems.sno='".$_REQUEST['sno']."'";
