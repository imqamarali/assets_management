...
<?php $td=0;$tc=0;$i=0; while($row2v = $result2v->fetch_assoc()){$i=$i+1; ?>    
    <tr>
      <td><?php echo $i; ?></td>
      <td><?php echo $row2v['name'];?></td>
      <td><?php echo $row2v['remarks'];?></td>
      <td><?php echo number_format($row2v['amount'],2)?></td>
      <td><?php echo number_format($row2v['amount1'],2)?></td>
