<?php
    ...
    $sqlp3= "SELECT * from projects  
	WHERE projects.id='".$row['salecenter']."'";
	$resultp3 = $conn->query($sqlp3);
	$resultpr3 = $resultp3->fetch_assoc();
    ...
    $sql2v = "SELECT * FROM payment 
              ...
              WHERE payment.pfor=1 AND payment.vid='" . $_REQUEST['id'] . "' ORDER BY payment.id ASC";
        ...
        <div id="page-wrap" style="background-color:#FFFFFF;">
            <div style="min-height: 400px;border: 1px solid #000; padding: 15px;">
                ...
                <div> 
                    <span>
                        <?php
                            if ($row['vtype'] == 1 or $row['vtype'] == 2 or $row['vtype'] == 5)
                            {
                                echo 'Paid To:';
                            }
