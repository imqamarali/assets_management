<?php 
    include "../db.php";
				...
				WHERE payment.pfor=1 and payment.vid='".$_REQUEST['id']."' Order By payment.id DESC";
...
<?php $i=0; $td=0;$tc=0; while($row2v = $result2v1->fetch_assoc()){$i=$i+1; ?>    
  ...
  <div style="margin-top: 1%;">
    ...
    <p style="margin-top: 3%;">Approved by:______________________________________ Received By:_____________________________________</p></br>
