  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td colspan="2" align="center" valign="middle" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid; font-size:18px; font-style:italic; font-weight:bold"><span class="style6"><?php echo $this->title;?></span></td>
                  <td width="120" valign="top" style="border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="25" style="border-bottom:inset; font-size:10px"><span class="style6"><?php echo date('y-m-d')?></span></td>
                    </tr>
                    <tr>
                ...
                <tr>
                  <td height="25" colspan="4" style="padding-left:5px; border-left:thin; border-left-style:solid; border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid"><span class="style6">Project:  <strong></strong></span></td>
                </tr>
                <tr>
    ...
    <tr>
      <td style="padding:0 10 0 10; border-top:thin; border-top-style:solid; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="65" valign="top" class="" style="border-left:thin; border-left-style:solid; border-bottom:thin; border-bottom-style:solid"><div align="center"><span class="BoledText style4" style="font-size:9px;"><img src="<?php echo Yii::$app->urlManager->baseUrl; ?>/images/RD logo.gif" width="60" height="20"></span></div></td>
