...
function renderMenuItems($items)
{
    foreach ($items as $item) {
        echo '<div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="index.php?r=' . htmlspecialchars($item['link']) . '&id=' . htmlspecialchars($item['module_id']) . '"  aria-expanded="false" aria-controls="nv-CRM">';
        echo '     <div class="d-flex align-items-center">';
        echo '              <div class="dropdown-indicator-icon">
                                <span class="fas fa-caret-right"></span>
                            </div>
                            <span class="nav-link-text">' . htmlspecialchars($item['title']) . '</span>';
        echo '            </div>';
        echo '         </a>';
        echo '          <div class="parent-wrapper label-1">';
