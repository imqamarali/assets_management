...
<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white">
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">Tehsils List</span>
                    <span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Managing Tehsil Table</p>
            </div>
        </div>
        <hr class="bg-200">
                ...
                <table class="table table-striped table-hover table-sm fs--1 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort border-top">Distrcit</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($can['can_delete'] == 1): ?>
                                        <div class="hidden-sm hidden-xs action-buttons"
                                            style="display: inline-flex; gap: 10px;">
                                            <form id="deleteForm_<?php echo $item['id']; ?>" action="index.php?r=config/tehsil"
...
<script>
    ...
    function update(item) {
        ...
        document.getElementById('modalDetails').value = item.details; // Ensure the correct status is selected
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3 mb-6" method="post" action="index.php?r=config/tehsil">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                            <input class="form-control" id="modalCode" name="code" type="text" placeholder="Code" ceho
                                required>
