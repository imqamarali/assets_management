...
<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white">
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">Treatment
                        List</span>
                    <span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Managing Treatment Table</p>
            </div>
        </div>
        <hr class="bg-200">
                                    ...
                                    <?php if ($can['can_delete'] == 1): ?>
                                        <div class="hidden-sm hidden-xs action-buttons"
                                            ...
                                            <form id="deleteForm_<?php echo $item['id']; ?>"
                                                action="index.php?r=config/treatment" method="POST" style="display: inline;">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3 mb-6" method="post" action="index.php?r=config/treatment">
