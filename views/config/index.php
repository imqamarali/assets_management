    ...
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce"><span class="fa-stack me-2 ms-n1">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span
                        class="bg-soft pe-2">Configurations</span><span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Basic configurations for system.</p>
            </div>
        </div>
        <hr class="bg-200">
        <div id="tableExample2">
            <div class="table-responsive">
                ...
                <div class="row align-items-start" style="margin:5px">
                    <?php foreach ($features_info as $submenu): ?>
                        <div class="submenu-item border rounded shadow-sm" style="width: 25%;padding:5px ;margin: 10px;">
                            <a href="index.php?r=<?= $submenu['link'] ?>" class="d-flex align-items-center text-dark">
