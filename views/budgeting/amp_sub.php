...
<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white">
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">AMP Sub</span>
                    <span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Managing AMP Sub Table</p>
            </div>
        </div>
        <hr class="bg-200">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if ($can['can_delete'] == 1): ?>
                                        <div class="hidden-sm hidden-xs action-buttons"
                                            style="display: inline-flex; gap: 10px;">
                                            <form id="deleteForm_<?php echo $item['id']; ?>" action="index.php?r=amp/amp_sub"
...
<script>
    ...
    function update(item) {
        ...
        document.getElementById('modalAmp').value = item.AMP_id;
        document.getElementById('modalType').value = item.typeofwork_id;
        document.getElementById('modalScope').value = item.scope_id;
        document.getElementById('modalRegion').value = item.region_id;
        document.getElementById('modalUnit').value = item.unit_id;
        ...
        document.getElementById('modalEstimate').value = item.engineer_estimate;
        document.getElementById('modalCost').value = item.cost;
        document.getElementById('modalRemarks').value = item.remarks;
        document.getElementById('modalDetails').value = item.discription;
    }
</script>
                ...
                <form class="row g-3 mb-6" method="post" action="index.php?r=amp/amp_sub">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-floating">
                            ...
                            <label for="modalZone">Select Zone<span style="color:red">*</span></label>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="form-floating">
                            ...
                            <label for="modalDistrict">Select District<span style="color:red">*</span></label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="form-floating">
                            <input class="form-control" id="modalCost" name="cost" type="text" placeholder="Cost"
                                required>
                            <label for="modalCost">Cost<span style="color:red">*</span></label>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <div class="form-floating">
