...
<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white">
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">Layers List</span>
                    <span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Managing Layers Table</p>
            </div>
                ...
                <table class=" table table-striped table-sm fs--1 mb-0 table-sm fs--1 leads-table simlee mt-3"
                    ...
                    <thead>
                        <tr style="margin: -3px;font-size: smaller;">
                            ...
                            <th class="sort border-top">P-Layer</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr style="margin: -3px;font-size: smaller;">
                            ...
                            <td>
                                ...
                                <div class="hidden-sm hidden-xs action-buttons"
                                    style="display: inline-flex; gap: 10px;">
                                    <form id="deleteForm_<?php echo $item['id']; ?>" action="index.php?r=assets/layers"
...
function update(item) {
    ...
    document.getElementById('modalPlayer').value = item.p_layer;
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3 mb-6" method="post" action="index.php?r=assets/layers">
                    ...
                    <div class="col-12 gy-6">
                        <div class="form-floating">
                            <input class="form-control" id="modalPlayer" name="p_layer" type="text"
                                placeholder="P_Layer" required>
                            <label for="modalPlayer">P_Layer</label>
                        </div>
                    </div>
