...
<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white">
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">Routes List</span>
                    <span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Managing Route Table</p>
            </div>
                ...
                <table class="table table-striped table-hover table-sm fs--1 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort border-top">From</th>
                            <th class="sort border-top">To</th>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="hidden-sm hidden-xs action-buttons"
                                    style="display: inline-flex; gap: 10px;">
                                    <form id="deleteForm_<?php echo $item['id']; ?>" action="index.php?r=assets/route"
...
function update(item) {
    ...
    document.getElementById('modalTo').value = item.to;
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3 mb-6" method="post" action="index.php?r=assets/route">
                    ...
                    <div class="col-sm-6 col-md-12">
                        <div class="form-floating">
                            <input class="form-control" id="modalTitle" name="title" type="text" placeholder="Title"
                                required>
                            <label for="modalTitle">Name <span style="color:red">*</span></label>
                        </div>
                    </div>

                    <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                            <input class="form-control" id="modalCode" name="code" type="text" placeholder="Code"
                                required>
                            <label for="modalCode">Code <span style="color:red">*</span></label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                            <input class="form-control" id="modalFrom" name="from" type="text" placeholder="From"
                                required>
                            <label for="modalFrom">From <span style="color:red">*</span></label>
                        </div>
                    </div>

                    <div class="col-sm-6 col-md-6">
                        <div class="form-floating">
                            <input class="form-control" id="modalTo" name="to" type="text" placeholder="Code" required>
                            <label for="modalTo">To <span style="color:red">*</span></label>
                        </div>
                    </div>
