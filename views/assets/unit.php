...
<div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white">
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">Unit List</span>
                    <span
                        class="border border-primary-200 position-absolute top-50 translate-middle-y w-100 start-0 z-index--1"></span>
                </h3>
                <p class="mb-0">Managing Unit Table</p>
            </div>
                            ...
                            <tr style="margin: -3px;font-size: smaller;">
                                ...
                                <td>
                                    ...
                                    <?php if ($can['can_delete'] == 1): ?>
                                        <div class="hidden-sm hidden-xs action-buttons"
                                            style="display: inline-flex; gap: 10px;">
                                            <form id="deleteForm_<?php echo $item['ID']; ?>" action="index.php?r=assets/unit"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3 mb-6" method="post" action="index.php?r=assets/unit">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="form-floating">
                            <select class="form-select" name="region_id" id="modalRegion" required>
                                ...
                                <?php foreach ($region_list as $item): ?>
                                    <option value="<?= $item['ID'] ?>">
                                        <?= $item['name']  ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <label for="modalRegion">Region<span style="color:red">*</span></label>
                        </div>
                    </div>
