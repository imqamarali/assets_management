                        ...
                        <tbody class="list">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <?php 
									foreach ($years as $year){
									$amp=Yii::$app->db->createCommand('SELECT sum(cost) as cost FROM public."amp_sub" where route_id='.$item['id'].' ')->queryOne();
									$con=Yii::$app->db->createCommand('SELECT sum(bid_cost) as bid_cost FROM public."m_contract" where route_id='.$item['id'].' ')->queryOne();
