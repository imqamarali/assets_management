            ...
            <div class="col-12 col-xl-8">
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span class="text-danger fas fa-user-tie fs-6"></span>
                            <div class="ms-3">

                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h4 class="mb-0">Contractor</h4>
                                </button>
                                <p class="text-800 fs--1 mb-0">Awating processing</p>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">

                                    <a class="dropdown-item" href="index.php?r=contract/contractor">View List</a>
                        ...
                        <div class="d-flex align-items-center"><span
                            ...
                            <div class="ms-3">
                                ...
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                                    ...
                                    <a class="dropdown-item" href="index.php?r=contract/contract">View List</a>
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span class="text-success fab fa-flipboard fs-3"></span>
                            <div class="ms-1">
                                ...
                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h6 style="margin-top: 24%;" class="mb-0">Payment (Finance)</h6>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                                    <a class="dropdown-item" href="index.php?r=contract/contract_payment">View List</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-xl-12">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="row gx-3">
                                    <h4 class="">Progress Reporting</h4>
                                    <hr class="bg-200">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-auto">
                                                    <div class="timeline-item-bar position-relative">
                                                        <div class="icon-item icon-item-md rounded-7 border"><svg
                                                                class="svg-inline--fa fa-clipboard text-success fs--1"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                                data-icon="clipboard" role="img"
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <div class="d-flex mb-2">
                                                            <h6 class="lh-sm mb-0 me-2 text-800 timeline-item-title">
                                                                Upload progress / Draft <br class="d-sm-none"> </h6>
                                                        </div>
                                                        <p class="text-500 fs--1 mb-0 text-nowrap timeline-time"><svg
                                                                class="svg-inline--fa fa-clock me-1" aria-hidden="true"
                                        ...
                                        <div class="timeline-item">
                                            <div class="row g-3">
                                                <div class="col-auto">
                                                    <div class="timeline-item-bar position-relative">
                                                        <div class="icon-item icon-item-md rounded-7 border"><svg
                                                                class="svg-inline--fa fa-envelope text-danger fs--1"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                ...
                                                <div class="col">
                                                    <div class="d-flex justify-content-between">
                                                        <div class="d-flex mb-2">
                                                            <h6 class="lh-sm mb-0 me-2 text-800 timeline-item-title">
                                                                Progress <br class="d-sm-none"> Verification</h6>
                                                        </div>
                                                        <p class="text-500 fs--1 mb-0 text-nowrap timeline-time"><svg
                                                                class="svg-inline--fa fa-clock me-1" aria-hidden="true"
                                                                focusable="false" data-prefix="far" data-icon="clock"
                                        ...
                                        <div class="timeline-item">
                                            <div class="row g-3">
                                                <div class="col-auto">
                                                    <div class="timeline-item-bar position-relative">
                                                        <div class="icon-item icon-item-md rounded-7 border"><svg
                                                                class="svg-inline--fa fa-video text-info fs--1"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <h6 class="fs--2 fw-normal false"><a class="fw-semi-bold"
                                                            href="#!">Head Office Reporting</a></h6>
