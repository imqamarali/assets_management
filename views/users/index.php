...
<div class="row">
    <div class="col_12">
        <div class="d-flex" id="scrollspyEcommerce"><span class="fa-stack me-2 ms-n1"><svg
            ...
            <div class="col">
                <h3 class="mb-0 text-primary position-relative fw-bold"><span class="bg-soft pe-2">User
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span
                                class="text-success fab fa-uniregistry fs-6"></span>
                            <div class="ms-3">

                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h4 class="mb-0">Maintenance Unit </h4>
                                </button>
                                <p class="text-800 fs--1 mb-0">Awating processing</p>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span class="text-info far fa-circle fs-3"></span>
                            <div class="ms-1">
                                ...
                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h6 style="margin-top: 24%;" class="mb-0">Roles</h6>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span
                            ...
                            <div class="ms-1">
                                ...
                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h6 style="margin-top: 24%;" class="mb-0">Permissions </h6>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span class="text-success fab fa-delicious fs-3"></span>
                            <div class="ms-1">
                                ...
                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h6 style="margin-top: 24%;" class="mb-0">Report</h6>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span class="text-success fab fa-flipboard fs-3"></span>
                            <div class="ms-1">
                                ...
                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h6 style="margin-top: 24%;" class="mb-0">Approval</h6>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                    ...
                    <div class="col-12 col-md-auto">
                        <div class="d-flex align-items-center"><span class="text-danger fas fa-road fs-3"></span>
                            <div class="ms-1">
                                ...
                                <button class="dropdown-toggle" id="disabledLinkExample" type="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <h6 style="margin-top: 24%;" class="mb-0">Widget</h6>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="disabledLinkExample">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex mb-2">
                                                                <h6
                                                                    ...
                                                                    Upload Changes / Draft <br class="d-sm-none"> </h6>
                                                            </div>
