    ...
    <div class="row">
        <div class="d-flex" id="scrollspyEcommerce">
            ...
            <div class="col">
                ...
                <p class="mb-0">Approved Progress Submission</p>
            </div>
        </div>
        <hr class="bg-200">
        <div class="mb-2">
            ...
            <div class="card h-5">
                <div class="profile-user-info profile-user-info-striped"
                    ...
                    <div style="width:20.5% ; padding: 5px"><?= $progress['contract_no'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Contractor Name:
                    </div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['contractor_name'] ?></div>
                    <div style="width: 12%;background: #EDF3F4; padding: 5px">Area:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['area'] ?></div>
                </div>
                <div
                    ...
                    <div style="width:20.5% ; padding: 5px"><?= $progress['type_name'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Scope:
                    </div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['scope_name'] ?></div>
                    <div style="width: 12%;background: #EDF3F4; padding: 5px">Progress:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['progress'] ?></div>
                </div>

                <div class="profile-user-info profile-user-info-striped"
                    style="display:flex; margin-top: 20px; font-size: smaller; margin:5px; margin-top:-5px;margin-right:10px; width: 100%;">
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Contract Date:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['contract_date'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Engineer Estimate:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['engineer_estimate'] ?></div>
                    <div style="width: 12%;background: #EDF3F4; padding: 5px">Bid Cost:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['bid_cost'] ?></div>
                </div>

                <div class="profile-user-info profile-user-info-striped"
                    style="display:flex; margin-top: 20px; font-size: smaller; margin:5px; margin-top:-5px;margin-right:10px; width: 100%;">
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Completion Date:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['date_of_completion'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Unit:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['unit_name'] ?></div>
                    <div style="width: 12%;background: #EDF3F4; padding: 5px">Region:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['region_name'] ?></div>
                </div>
                <div class="profile-user-info profile-user-info-striped"
                    style="display:flex; margin-top: 20px; font-size: smaller; margin:5px; margin-top:-5px;margin-right:10px; width: 100%;">
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Route:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['route_name'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">District:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['district_name'] ?></div>
            ...
            <div class="card h-5">
                <div class="profile-user-info profile-user-info-striped"
                    ...
                    <div style="width:20.5% ; padding: 5px"><?= $progress['task'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">Progress Details:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['details'] ?></div>
                    <div style="width: 12%;background: #EDF3F4; padding: 5px">Progress:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['progress'] ?></div>
                </div>
                <div class="profile-user-info profile-user-info-striped"
                    ...
                    <div style="width:20.5% ; padding: 5px"><?= $progress['start_date'] ?></div>
                    <div style="width:12% ;background: #EDF3F4; padding: 5px">End Date:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['end_date'] ?></div>
                ...
                <div class="profile-user-info profile-user-info-striped"
                    ...
                    <div style="width:20.5% ; padding: 5px"><?= $progress['submitted_by'] ?></div>
                    <div style="width: 12%;background: #EDF3F4; padding: 5px">Submission Date:</div>
                    <div style="width:20.5% ; padding: 5px"><?= $progress['submission_date'] ?></div>
                </div>
        ...
        <form id="progressStatusForm"
            action="index.php?r=notification/progressdetails&referance=<?= $_REQUEST['referance'] ?>" method="POST">
            ...
            $new_status = null;
            $reject_status = null;
            $progress_status = ''; // Default condition

            $status = $progress['progress_status']; // Current progress status
